...
public class App {
    ...
    public static void initStorage() {
        ...
        Fad fad5 = Controller.createFad(6,"Birk",5000, "Sherry");
        ArrayList<MængdePåfyldt> mængderPåfyldt2 = new ArrayList<>(List.of(new MængdePåfyldt(NM12P, 150)));
        ArrayList<MængdePåfyldt> mængderPåfyldt3 = new ArrayList<>(List.of(new MængdePåfyldt(NM12P, 15), (new MængdePåfyldt(NM22P, 20))));
